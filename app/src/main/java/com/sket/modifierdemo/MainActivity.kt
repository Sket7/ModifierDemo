...
import com.sket.modifierdemo.ui.theme.ModifierDemoTheme
...
fun DemoScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        DemoText(text = "Welcome to Compose", fontSize = sliderPosition)
...
@Composable
fun DemoText(text: String, fontSize: Float) {
    Text(
        text = text,
